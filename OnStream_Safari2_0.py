...
class TestVersion:
    def test_main_logo(self, onstream_version, onstream_url):
        try:
            ...
            self.driver.find_element(By.XPATH,
                                     '//*[@id="HEADER_CONTAINER"]/div[1]/img').click()  # Click on the logo on the upper left
...
class TestHomeScreen:
    def test_hero_screen(self, onstream_version, onstream_url, ):
        try:
    ...
    def test_featured_channels(self, onstream_version, onstream_url, ):
        try:
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
    ...
    def test_sports(self, onstream_version, onstream_url, ):
        try:
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(5)
...
@pytest.mark.usefixtures("setup", "directory")
class TestGuide:
    def test_modern_guide(self, onstream_version, onstream_url, ):
        try:
            ...
            for i in range(len(play_buttons)):
                ...
                time.sleep(2)
                self.driver.find_element(By.XPATH,
                                         '//*[@id="dish-bitmovin-player"]/div[3]/div/div[2]/div[1]/button/img').click()  # Click volume button
                time.sleep(3)
                '''self.driver.find_element(By.XPATH, '//*[@id="dish-bitmovin-player"]/div[3]/div/div[2]/div[2]/button').click()  # Click CC button
                time.sleep(3)
                self.driver.find_element(By.XPATH, '//*[@id="subtitle-popper"]/ul/div[3]').click()  #CC English  button
                time.sleep(3)
    ...
    def test_classic_guide(self, onstream_version, onstream_url, ):
        try:
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))
            time.sleep(3)
...
@pytest.mark.usefixtures("setup", "directory")
class TestDemand:
    def test_on_demand(self, onstream_version, onstream_url, ):
        try:
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(3)
...
@pytest.mark.usefixtures("setup", "directory")
class TestSearch:
    def test_search_button(self, onstream_version, onstream_url, ):
        try:
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))
            time.sleep(3)
            WebDriverWait(self.driver, 60).until(ec.presence_of_element_located(
...
@pytest.mark.usefixtures("setup", "directory")
class TestSettings:
    def test_settings(self, onstream_version, onstream_url, ):
        try:
            WebDriverWait(self.driver, 60).until(
                ec.presence_of_element_located((By.XPATH, UI_Constant.home_button)))  # Wait for the Home Page to Load
            time.sleep(2)
